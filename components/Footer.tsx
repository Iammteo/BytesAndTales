  ...
  return (
    <footer className="bg-ink text-cream py-24 relative overflow-hidden">
      <div className="wrap">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 font-serif text-cream/85">
              ...
              <li>
                <a href={`mailto:${site.email}`} className="hover:text-orange-soft transition-colors">
                  Email
                </a>
              </li>
            </ul>
        ...
        {/* Legal — required for UK food businesses */}
        <div className="mt-6 pt-6 border-t border-cream/10 font-sans text-[9px] uppercase tracking-[0.18em] text-cream/40 text-center">
          Food Hygiene Rating · 5 (Very Good) · {site.localAuthority} ·  All allergens declared on each item
        </div>
      </div>
    </footer>
  );
